...
# -*- coding: utf-8 -*-
"""
Created on Sat Sep  7 23:55:08 2019
...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 18:17:23 2019
...
class Student:
    ...
    #Local variable
    # jk removed list and move to init __ # initially empty
    
    def __init__(self, name, id):  # constructor
        self.name = name
        self.id = id
        self.grades = []           # jk moved variable inside init to keep grades separate
...
print (student1.grades)     # jk added print to check grades student1
print (s2.grades)           # jk added print to check grades s2
